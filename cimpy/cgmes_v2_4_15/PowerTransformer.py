...
class PowerTransformer(ConductingEquipment):
    ...
    possibleProfileList = {
        ...
        "PowerTransformerEnd": [Profile.EQ.value, ],
        "beforeShCircuitHighestOperatingCurrent": [Profile.EQ.value, ],
        "beforeShCircuitHighestOperatingVoltage": [Profile.EQ.value, ],
        "beforeShortCircuitAnglePf": [Profile.EQ.value, ],
        "highSideMinOperatingU": [Profile.EQ.value, ],
        "isPartOfGeneratorUnit": [Profile.EQ.value, ],
        "operationalValuesConsidered": [Profile.EQ.value, ],
    }
