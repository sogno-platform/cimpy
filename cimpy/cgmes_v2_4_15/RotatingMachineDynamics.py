...
class RotatingMachineDynamics(DynamicsFunctionBlock):
    ...
    possibleProfileList = {
        ...
        "damping": [Profile.DY.value, ],
        "inertia": [Profile.DY.value, ],
        "saturationFactor": [Profile.DY.value, ],
        "saturationFactor120": [Profile.DY.value, ],
        "statorLeakageReactance": [Profile.DY.value, ],
        "statorResistance": [Profile.DY.value, ],
    }
