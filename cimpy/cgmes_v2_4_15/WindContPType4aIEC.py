...
class WindContPType4aIEC(IdentifiedObject):
	...
	:WindTurbineType4aIEC: Wind turbine type 4A model with which this wind control P type 4A model is associated. Default: 
		'''
	...
	possibleProfileList = {'class': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'DY'}.value, ],
						...
						'WindTurbineType4aIEC': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'DY'}.value, ],
						 }
	...
	def __init__(self, dpmax = , tpord = , tufilt = , WindTurbineType4aIEC = ,  *args, **kw_args):
