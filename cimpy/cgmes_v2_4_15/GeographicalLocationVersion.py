...
class GeographicalLocationVersion(Base):
    ...
    possibleProfileList = {
        ...
        "baseUML": [Profile.GL.value, ],
        "baseURI": [Profile.GL.value, ],
        "date": [Profile.GL.value, ],
        "differenceModelURI": [Profile.GL.value, ],
        "entsoeUML": [Profile.GL.value, ],
        "entsoeURI": [Profile.GL.value, ],
        "modelDescriptionURI": [Profile.GL.value, ],
        "namespaceRDF": [Profile.GL.value, ],
        "namespaceUML": [Profile.GL.value, ],
        "shortName": [Profile.GL.value, ],
    }
