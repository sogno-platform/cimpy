...
class GovHydroIEEE2(TurbineGovernorDynamics):
	...
	:uc: Maximum gate closing velocity (Uc) (<0).  Typical Value = -0.1. Default: 
	:pmax: Maximum gate opening (Pmax).  Typical Value = 1. Default: 
	:pmin: Minimum gate opening (Pmin).  Typical Value = 0. Default: 
	...
	def __init__(self, mwbase = , tg = , tp = , uo = , uc = , pmax = , pmin = , rperm = , rtemp = , tr = , tw = , kturb = , aturb = , bturb = , gv1 = , pgv1 = , gv2 = , pgv2 = , gv3 = , pgv3 = , gv4 = , pgv4 = , gv5 = , pgv5 = , gv6 = , pgv6 = ,  *args, **kw_args):
