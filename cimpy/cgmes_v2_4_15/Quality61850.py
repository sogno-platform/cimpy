...
class Quality61850(Base):
    ...
    possibleProfileList = {
        ...
        "badReference": [Profile.EQ.value, ],
        "estimatorReplaced": [Profile.EQ.value, ],
        "failure": [Profile.EQ.value, ],
        "oldData": [Profile.EQ.value, ],
        "operatorBlocked": [Profile.EQ.value, ],
        "oscillatory": [Profile.EQ.value, ],
        "outOfRange": [Profile.EQ.value, ],
        "overFlow": [Profile.EQ.value, ],
        "source": [Profile.EQ.value, ],
        "suspect": [Profile.EQ.value, ],
        "test": [Profile.EQ.value, ],
        "validity": [Profile.EQ.value, ],
    }
