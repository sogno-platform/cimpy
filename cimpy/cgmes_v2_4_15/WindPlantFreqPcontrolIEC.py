...
class WindPlantFreqPcontrolIEC(IdentifiedObject):
	...
	def __init__(self, WindDynamicsLookupTable = "many", dprefmax = 0.0, dprefmin = 0.0, kiwpp = 0.0, kpwpp = 0.0, prefmax = 0.0, prefmin = 0.0, tpft = 0, tpfv = 0, twpffilt = 0, twppfilt = 0, WindPlantIEC = None,  *args, **kw_args):
