...
class PowerTransformerEnd(TransformerEnd):
	...
	:PowerTransformer: The ends of this power transformer. Default: 
	:b: Magnetizing branch susceptance (B mag).  The value can be positive or negative. Default: 
	:connectionKind: Kind of connection. Default: 
	:ratedS: Normal apparent power rating. The attribute shall be a positive value. For a two-winding transformer the values for the high and low voltage sides shall be identical. Default: 
	:g: Magnetizing branch conductance. Default: 
	:ratedU: Rated voltage: phase-phase for three-phase windings, and either phase-phase or phase-neutral for single-phase windings. A high voltage side, as given by TransformerEnd.endNumber, shall have a ratedU that is greater or equal than ratedU for the lower voltage sides. Default: 
	:r: Resistance (star-model) of the transformer end. The attribute shall be equal or greater than zero for non-equivalent transformers. Default: 
	:x: Positive sequence series reactance (star-model) of the transformer end. Default: 
	:b0: Zero sequence magnetizing branch susceptance. Default: 
	...
	:g0: Zero sequence magnetizing branch conductance (star-model). Default: 
	:r0: Zero sequence series resistance (star-model) of the transformer end. Default: 
	:x0: Zero sequence series reactance of the transformer end. Default: 
		'''
	...
	def __init__(self, PowerTransformer = , b = , connectionKind = , ratedS = , g = , ratedU = , r = , x = , b0 = , phaseAngleClock = , g0 = , r0 = , x0 = ,  *args, **kw_args):
