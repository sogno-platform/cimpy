...
class MeasurementValue(IdentifiedObject):
	...
	:sensorAccuracy: The limit, expressed as a percentage of the sensor maximum, that errors will not exceed when the sensor is used under  reference conditions. Default: 
	:MeasurementValueQuality: A MeasurementValue has a MeasurementValueQuality associated with it. Default: 
	:MeasurementValueSource: The MeasurementValues updated by the source. Default: 
		'''
	...
	def __init__(self, timeStamp = , sensorAccuracy = , MeasurementValueQuality = , MeasurementValueSource = ,  *args, **kw_args):
