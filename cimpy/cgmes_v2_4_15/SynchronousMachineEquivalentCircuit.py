...
class SynchronousMachineEquivalentCircuit(SynchronousMachineDetailed):
	...
	:xad: D-axis mutual reactance. Default: 
	:rfd: Field winding resistance. Default: 
	:xfd: Field winding leakage reactance. Default: 
	:r1d: D-axis damper 1 winding resistance. Default: 
	:x1d: D-axis damper 1 winding leakage reactance. Default: 
	:xf1d: Differential mutual (`Canay`) reactance. Default: 
	:xaq: Q-axis mutual reactance. Default: 
	:r1q: Q-axis damper 1 winding resistance. Default: 
	:x1q: Q-axis damper 1 winding leakage reactance. Default: 
	:r2q: Q-axis damper 2 winding resistance. Default: 
	:x2q: Q-axis damper 2 winding leakage reactance. Default: 
		'''
	...
	def __init__(self, xad = , rfd = , xfd = , r1d = , x1d = , xf1d = , xaq = , r1q = , x1q = , r2q = , x2q = ,  *args, **kw_args):
