...
class StateVariablesVersion(Base):
    ...
    possibleProfileList = {
        ...
        "baseUML": [Profile.SV.value, ],
        "baseURI": [Profile.SV.value, ],
        "date": [Profile.SV.value, ],
        "differenceModelURI": [Profile.SV.value, ],
        "entsoeUML": [Profile.SV.value, ],
        "entsoeURI": [Profile.SV.value, ],
        "modelDescriptionURI": [Profile.SV.value, ],
        "namespaceRDF": [Profile.SV.value, ],
        "namespaceUML": [Profile.SV.value, ],
        "shortName": [Profile.SV.value, ],
    }
