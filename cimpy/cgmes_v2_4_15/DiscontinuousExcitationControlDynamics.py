...
class DiscontinuousExcitationControlDynamics(DynamicsFunctionBlock):
	...
	:RemoteInputSignal: Remote input signal used by this discontinuous excitation control system model. Default: 
	:ExcitationSystemDynamics: Excitation system model with which this discontinuous excitation control model is associated. Default: 
		'''
