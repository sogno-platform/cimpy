...
class ExcAC3A(ExcitationSystemDynamics):
	...
	:ka: Voltage regulator gain (Ka).  Typical Value = 45.62. Default: 
	:ta: Voltage regulator time constant (Ta).  Typical Value = 0.013. Default: 
	...
	:te: Exciter time constant, integration rate associated with exciter control (Te).  Typical Value = 1.17. Default: 
	:vemin: Minimum exciter voltage output (Vemin).  Typical Value = 0.1. Default: 
	:kr: Constant associated with regulator and alternator field power supply (Kr).  Typical Value =3.77. Default: 
	:kf: Excitation control system stabilizer gains (Kf).  Typical Value = 0.143. Default: 
	:tf: Excitation control system stabilizer time constant (Tf).  Typical Value = 1. Default: 
	:kn: Excitation control system stabilizer gain (Kn).  Typical Value =0.05. Default: 
	:efdn: Value of at which feedback gain changes (Efdn).  Typical Value = 2.36. Default: 
	:kc: Rectifier loading factor proportional to commutating reactance (Kc).  Typical Value = 0.104. Default: 
	:kd: Demagnetizing factor, a function of exciter alternator reactances (Kd).  Typical Value = 0.499. Default: 
	:ke: Exciter constant related to self-excited field (Ke).  Typical Value = 1. Default: 
	:klv: Gain used in the minimum field voltage limiter loop (Klv).  Typical Value = 0.194. Default: 
	:kf1: Coefficient to allow different usage of the model (Kf1).  Typical Value = 1. Default: 
	:kf2: Coefficient to allow different usage of the model (Kf2).  Typical Value = 0. Default: 
	:ks: Coefficient to allow different usage of the model-speed coefficient (Ks).  Typical Value = 0. Default: 
	:vfemax: Exciter field current limit reference (Vfemax).  Typical Value = 16. Default: 
	:ve1: Exciter alternator output voltages back of commutating reactance at which saturation is defined (Ve1) equals Vemax (Ve1).  Typical Value = 6.24. Default: 
	:seve1: Exciter saturation function value at the corresponding exciter voltage, Ve, back of commutating reactance (Se[Ve]).  Typical Value = 1.143. Default: 
	:ve2: Exciter alternator output voltages back of commutating reactance at which saturation is defined (Ve).  Typical Value = 4.68. Default: 
	:seve2: Exciter saturation function value at the corresponding exciter voltage, Ve, back of commutating reactance (Se[Ve]).  Typical Value = 0.1. Default: 
	:vlv: Field voltage used in the minimum field voltage limiter loop (Vlv).  Typical Value = 0.79. Default: 
		'''
	...
	possibleProfileList = {'class': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'DY'}.value, ],
						...
						'klv': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'DY'}.value, ],
						...
						'vlv': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'DY'}.value, ],
						 }
	...
	def __init__(self, tb = , tc = , ka = , ta = , vamax = , vamin = , te = , vemin = , kr = , kf = , tf = , kn = , efdn = , kc = , kd = , ke = , klv = , kf1 = , kf2 = , ks = , vfemax = , ve1 = , seve1 = , ve2 = , seve2 = , vlv = ,  *args, **kw_args):
