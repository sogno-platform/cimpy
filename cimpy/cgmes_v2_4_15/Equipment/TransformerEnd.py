...
class TransformerEnd(IdentifiedObject):
	...
	def __init__(self, BaseVoltage = None, Terminal = None, PhaseTapChanger = None, RatioTapChanger = None, endNumber = 0.0, rground = 0.0, grounded = False, xground = 0.0,  *args, **kw_args):
