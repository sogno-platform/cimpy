...
class IdentifiedObject(Base):
	...
	reference_dict = { 'DiagramLayoutVersion': ['DiagramObjects', ],
					'DynamicsVersion': ['name', ],
					 } 

	

	def __init__(self, description = '', energyIdentCodeEic = '', mRID = '', name = '', shortName = '', DiagramObjects = [],  ):
