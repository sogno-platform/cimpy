...
class BusNameMarker(IdentifiedObject):
	...
	:priority: Priority of bus name marker for use as topology bus name.  Use 0 for don t care.  Use 1 for highest priority.  Use 2 as priority is less than 1 and so on. Default: 
	:ReportingGroup: The bus name markers that belong to this reporting group. Default: 
	...
	possibleProfileList = {'class': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'EQ'}.value, ],
						'priority': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'EQ'}.value, ],
						'ReportingGroup': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'EQ'}.value, ],
	...
	def __init__(self, priority = , ReportingGroup = , Terminal = ,  *args, **kw_args):
