...
class PetersenCoil(EarthFaultCompensator):
    ...
    possibleProfileList = {
        ...
        "nominalU": [Profile.EQ.value, ],
        "offsetCurrent": [Profile.EQ.value, ],
        "positionCurrent": [Profile.EQ.value, ],
        "xGroundMax": [Profile.EQ.value, ],
        "xGroundMin": [Profile.EQ.value, ],
        "xGroundNominal": [Profile.EQ.value, ],
    }
