...
class DiagramLayoutVersion(Base):
    ...
    possibleProfileList = {
        ...
        "baseUML": [Profile.DL.value, ],
        "baseURI": [Profile.DL.value, ],
        "date": [Profile.DL.value, ],
        "differenceModelURI": [Profile.DL.value, ],
        "entsoeUML": [Profile.DL.value, ],
        "entsoeURI": [Profile.DL.value, ],
        "modelDescriptionURI": [Profile.DL.value, ],
        "namespaceRDF": [Profile.DL.value, ],
        "namespaceUML": [Profile.DL.value, ],
        "shortName": [Profile.DL.value, ],
    }
