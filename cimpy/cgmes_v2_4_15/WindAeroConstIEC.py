...
class WindAeroConstIEC(IdentifiedObject):
	...
	:WindGenTurbineType1IEC: Wind turbine type 1 model with which this wind aerodynamic model is associated. Default: 
		'''

	cgmesProfile = IdentifiedObject.cgmesProfile

	possibleProfileList = {'class': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'DY'}.value, ],
						'WindGenTurbineType1IEC': [cgmesProfile.{'$rdf:datatype': 'http://www.w3.org/2001/XMLSchema#string', '_': 'DY'}.value, ],
						 }
	...
	def __init__(self, WindGenTurbineType1IEC = ,  *args, **kw_args):
