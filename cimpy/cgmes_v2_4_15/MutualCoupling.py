...
class MutualCoupling(IdentifiedObject):
    ...
    possibleProfileList = {
        ...
        "First_Terminal": [Profile.EQ.value, ],
        "Second_Terminal": [Profile.EQ.value, ],
        "b0ch": [Profile.EQ.value, ],
        "distance11": [Profile.EQ.value, ],
        "distance12": [Profile.EQ.value, ],
        "distance21": [Profile.EQ.value, ],
        "distance22": [Profile.EQ.value, ],
