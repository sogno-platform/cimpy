...
class OperationalLimitType(IdentifiedObject):
	...
	:OperationalLimit: The operational limits associated with this type of limit. Default: "many"
	...
	def __init__(self, OperationalLimit = "many", acceptableDuration = 0.0, limitType = None, direction = None,  *args, **kw_args):
