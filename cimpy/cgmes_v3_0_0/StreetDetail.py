...
class StreetDetail(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.GL.value, ],
						'number': [cgmesProfile.GL.value, ],
						'name': [cgmesProfile.GL.value, ],
						'suffix': [cgmesProfile.GL.value, ],
						'prefix': [cgmesProfile.GL.value, ],
						'type': [cgmesProfile.GL.value, ],
						'code': [cgmesProfile.GL.value, ],
						'buildingName': [cgmesProfile.GL.value, ],
						'suiteNumber': [cgmesProfile.GL.value, ],
						'addressGeneral': [cgmesProfile.GL.value, ],
						'addressGeneral2': [cgmesProfile.GL.value, ],
						'addressGeneral3': [cgmesProfile.GL.value, ],
						'withinTownLimits': [cgmesProfile.GL.value, ],
						'floorIdentification': [cgmesProfile.GL.value, ],
						 }
	...
	def __init__(self, number = '', name = '', suffix = '', prefix = '', type = '', code = '', buildingName = '', suiteNumber = '', addressGeneral = '', addressGeneral2 = '', addressGeneral3 = '', withinTownLimits = False, floorIdentification = '',  ):
