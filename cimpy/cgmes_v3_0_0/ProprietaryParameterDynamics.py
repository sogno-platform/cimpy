...
class ProprietaryParameterDynamics(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, ],
						'CSCUserDefined': [cgmesProfile.DY.value, ],
						'SVCUserDefined': [cgmesProfile.DY.value, ],
						'VSCUserDefined': [cgmesProfile.DY.value, ],
