...
class WindPlantFreqPcontrolIEC(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, ],
						...
						'dpwprefmax': [cgmesProfile.DY.value, ],
						'dpwprefmin': [cgmesProfile.DY.value, ],
						'prefmax': [cgmesProfile.DY.value, ],
						'prefmin': [cgmesProfile.DY.value, ],
						'kiwpp': [cgmesProfile.DY.value, ],
						'kiwppmax': [cgmesProfile.DY.value, ],
						'kiwppmin': [cgmesProfile.DY.value, ],
						'kpwpp': [cgmesProfile.DY.value, ],
						'kwppref': [cgmesProfile.DY.value, ],
						'tpft': [cgmesProfile.DY.value, ],
						'tpfv': [cgmesProfile.DY.value, ],
						'twpffiltp': [cgmesProfile.DY.value, ],
						'twppfiltp': [cgmesProfile.DY.value, ],
	...
	def __init__(self, WindDynamicsLookupTable = "list", dprefmax = 0.0, dprefmin = 0.0, dpwprefmax = 0.0, dpwprefmin = 0.0, prefmax = 0.0, prefmin = 0.0, kiwpp = 0.0, kiwppmax = 0.0, kiwppmin = 0.0, kpwpp = 0.0, kwppref = 0.0, tpft = 0, tpfv = 0, twpffiltp = 0, twppfiltp = 0, WindPlantIEC = None,  *args, **kw_args):
