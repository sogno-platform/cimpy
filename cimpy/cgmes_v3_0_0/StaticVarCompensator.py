...
class StaticVarCompensator(RegulatingCondEq):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.EQ.value, ],
						'StaticVarCompensatorDynamics': [cgmesProfile.DY.value, ],
	...
	def __init__(self, StaticVarCompensatorDynamics = None, q = 0.0, capacitiveRating = 0.0, inductiveRating = 0.0, slope = 0.0, sVCControlMode = None, voltageSetPoint = 0.0,  *args, **kw_args):
