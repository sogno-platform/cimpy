...
class Pss1(PowerSystemStabilizerDynamics):
	...
	def __init__(self, komega = 0.0, kf = 0.0, kpe = 0.0, pmin = 0.0, ks = 0.0, vsmn = 0.0, vsmx = 0.0, tpe = 0, t5 = 0, t6 = 0, t7 = 0, t8 = 0, t9 = 0, t10 = 0, vadat = False,  *args, **kw_args):
