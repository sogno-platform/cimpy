...
class ConductingEquipment(Equipment):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, cgmesProfile.SC.value, cgmesProfile.SV.value, ],
						'Terminals': [cgmesProfile.DY.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
