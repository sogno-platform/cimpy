...
class IdentifiedObject(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.GL.value, cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, cgmesProfile.SC.value, cgmesProfile.SV.value, ],
						'mRID': [cgmesProfile.GL.value, cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, cgmesProfile.SC.value, cgmesProfile.SV.value, ],
						'name': [cgmesProfile.GL.value, cgmesProfile.DY.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, cgmesProfile.SV.value, ],
						'description': [cgmesProfile.DY.value, cgmesProfile.DL.value, cgmesProfile.TP.value, cgmesProfile.OP.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'DiagramObjects': [cgmesProfile.DL.value, ],
						'energyIdentCodeEic': [cgmesProfile.TP.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'shortName': [cgmesProfile.TP.value, cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						 }
	...
	def __init__(self, mRID = '', name = '', description = '', DiagramObjects = "list", energyIdentCodeEic = '', shortName = '',  ):
