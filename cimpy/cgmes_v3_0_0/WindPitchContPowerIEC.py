...
class WindPitchContPowerIEC(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, ],
						...
						'WindGenTurbineType1bIEC': [cgmesProfile.DY.value, ],
						'WindGenTurbineType2IEC': [cgmesProfile.DY.value, ],
						'dpmax': [cgmesProfile.DY.value, ],
						'dpmin': [cgmesProfile.DY.value, ],
						'pmin': [cgmesProfile.DY.value, ],
						'pset': [cgmesProfile.DY.value, ],
						't1': [cgmesProfile.DY.value, ],
						'tr': [cgmesProfile.DY.value, ],
						'uuvrt': [cgmesProfile.DY.value, ],
						 }
	...
	def __init__(self, WindDynamicsLookupTable = "list", WindGenTurbineType1bIEC = None, WindGenTurbineType2IEC = None, dpmax = 0.0, dpmin = 0.0, pmin = 0.0, pset = 0.0, t1 = 0, tr = 0, uuvrt = 0.0,  *args, **kw_args):
