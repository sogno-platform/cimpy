...
class ApparentPowerLimit(OperationalLimit):
	...
	:value: The apparent power limit. The attribute shall be a positive value or zero. Default: 0.0
	:normalValue: The normal apparent power limit. The attribute shall be a positive value or zero. Default: 0.0
		'''
