...
class ExcDC3A(ExcitationSystemDynamics):
	...
	def __init__(self, trh = 0, ks = 0.0, kr = 0.0, kv = 0.0, vrmax = 0.0, vrmin = 0.0, te = 0, ke = 0.0, efd1 = 0.0, seefd1 = 0.0, efd2 = 0.0, seefd2 = 0.0, exclim = False, efdmax = 0.0, efdmin = 0.0, efdlim = False,  *args, **kw_args):
