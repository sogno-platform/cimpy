...
class SeriesCompensator(ConductingEquipment):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.SC.value, ],
						...
						'varistorPresent': [cgmesProfile.SC.value, ],
						'varistorRatedCurrent': [cgmesProfile.SC.value, ],
						'varistorVoltageThreshold': [cgmesProfile.SC.value, ],
						 }
	...
	def __init__(self, r = 0.0, x = 0.0, r0 = 0.0, x0 = 0.0, varistorPresent = False, varistorRatedCurrent = 0.0, varistorVoltageThreshold = 0.0,  *args, **kw_args):
