...
class WindContPitchAngleIEC(IdentifiedObject):
	...
	def __init__(self, dthetamax = 0.0, dthetamin = 0.0, kic = 0.0, kiomega = 0.0, kpc = 0.0, kpomega = 0.0, kpx = 0.0, thetamax = 0.0, thetamin = 0.0, ttheta = 0, WindTurbineType3IEC = None,  *args, **kw_args):
