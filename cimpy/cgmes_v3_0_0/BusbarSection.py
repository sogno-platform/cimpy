...
class BusbarSection(Connector):
	...
	:ipMax: Maximum allowable peak short-circuit current of busbar (Ipmax in IEC 60909-0).  Mechanical limit of the busbar in the substation itself. Used for short circuit data exchange according to IEC 60909. Default: 0.0
		'''

	cgmesProfile = Connector.cgmesProfile

	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.SC.value, ],
						'ipMax': [cgmesProfile.SC.value, ],
						 }
