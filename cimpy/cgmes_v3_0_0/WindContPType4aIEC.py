...
class WindContPType4aIEC(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, ],
						'dpmaxp4a': [cgmesProfile.DY.value, ],
						'tpordp4a': [cgmesProfile.DY.value, ],
						'tufiltp4a': [cgmesProfile.DY.value, ],
	...
	def __init__(self, dpmaxp4a = 0.0, tpordp4a = 0, tufiltp4a = 0, WindTurbineType4aIEC = None,  *args, **kw_args):
