...
class DCLineSegment(DCConductingEquipment):
	...
	:inductance: Inductance of the DC line segment. Negligible compared with DCSeriesDevice used for smoothing. Default: 0.0
	...
	def __init__(self, capacitance = 0.0, inductance = 0.0, resistance = 0.0, length = 0.0,  *args, **kw_args):
