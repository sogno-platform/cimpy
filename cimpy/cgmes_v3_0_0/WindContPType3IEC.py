...
class WindContPType3IEC(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, ],
						...
						'dthetamaxuvrt': [cgmesProfile.DY.value, ],
						'kdtd': [cgmesProfile.DY.value, ],
						'kip': [cgmesProfile.DY.value, ],
						'kpp': [cgmesProfile.DY.value, ],
						'mpuvrt': [cgmesProfile.DY.value, ],
						'omegaoffset': [cgmesProfile.DY.value, ],
						'pdtdmax': [cgmesProfile.DY.value, ],
						'tdvs': [cgmesProfile.DY.value, ],
						'thetaemin': [cgmesProfile.DY.value, ],
						'thetauscale': [cgmesProfile.DY.value, ],
						'tomegafiltp3': [cgmesProfile.DY.value, ],
						'tpfiltp3': [cgmesProfile.DY.value, ],
						'tpord': [cgmesProfile.DY.value, ],
						'tufiltp3': [cgmesProfile.DY.value, ],
						'tomegaref': [cgmesProfile.DY.value, ],
						'udvs': [cgmesProfile.DY.value, ],
						'updip': [cgmesProfile.DY.value, ],
						'omegadtd': [cgmesProfile.DY.value, ],
	...
	def __init__(self, dpmax = 0.0, dprefmax = 0.0, dprefmin = 0.0, dthetamax = 0.0, dthetamaxuvrt = 0.0, kdtd = 0.0, kip = 0.0, kpp = 0.0, mpuvrt = False, omegaoffset = 0.0, pdtdmax = 0.0, tdvs = 0, thetaemin = 0.0, thetauscale = 0.0, tomegafiltp3 = 0, tpfiltp3 = 0, tpord = 0.0, tufiltp3 = 0, tomegaref = 0, udvs = 0.0, updip = 0.0, omegadtd = 0.0, zeta = 0.0, WindTurbineType3IEC = None, WindDynamicsLookupTable = "list",  *args, **kw_args):
