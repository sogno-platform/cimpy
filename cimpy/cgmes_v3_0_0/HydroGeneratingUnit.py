...
class HydroGeneratingUnit(GeneratingUnit):
	...
	possibleProfileList = {'class': [cgmesProfile.SSH.value, cgmesProfile.EQ.value, ],
						...
						'dropHeight': [cgmesProfile.EQ.value, ],
						'turbineType': [cgmesProfile.EQ.value, ],
	...
	def __init__(self, energyConversionCapability = None, dropHeight = 0.0, turbineType = None, HydroPowerPlant = None,  *args, **kw_args):
