...
class ExternalNetworkInjection(RegulatingCondEq):
	...
	:maxQ: Maximum reactive power limit. It is used for modelling of infeed for load flow exchange and not for short circuit modelling. Default: 0.0
	:minP: Minimum active power of the injection. Default: 0.0
	:minQ: Minimum reactive power limit. It is used for modelling of infeed for load flow exchange and not for short circuit modelling. Default: 0.0
	:ikSecond: Indicates whether initial symmetrical short-circuit current and power have been calculated according to IEC (Ik`).  Used only if short circuit calculations are done according to superposition method. Default: False
	...
	:voltageFactor: Voltage factor in pu, which was used to calculate short-circuit current Ik` and power Sk`.  Used only if short circuit calculations are done according to superposition method. Default: 0.0
		'''
	...
	possibleProfileList = {'class': [cgmesProfile.SSH.value, cgmesProfile.EQ.value, cgmesProfile.SC.value, ],
						...
						'ikSecond': [cgmesProfile.SC.value, ],
						'maxInitialSymShCCurrent': [cgmesProfile.SC.value, ],
						'maxR0ToX0Ratio': [cgmesProfile.SC.value, ],
						'maxR1ToX1Ratio': [cgmesProfile.SC.value, ],
						'maxZ0ToZ1Ratio': [cgmesProfile.SC.value, ],
						'minInitialSymShCCurrent': [cgmesProfile.SC.value, ],
						'minR0ToX0Ratio': [cgmesProfile.SC.value, ],
						'minR1ToX1Ratio': [cgmesProfile.SC.value, ],
						'minZ0ToZ1Ratio': [cgmesProfile.SC.value, ],
						'voltageFactor': [cgmesProfile.SC.value, ],
						 }
