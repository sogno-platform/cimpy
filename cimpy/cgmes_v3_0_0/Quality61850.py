...
class Quality61850(Base):
	...
	:suspect: A correlation function has detected that the value is not consistent with other values. Typically set by a network State Estimator. Default: False
	...
	possibleProfileList = {'class': [cgmesProfile.OP.value, ],
						'badReference': [cgmesProfile.OP.value, ],
						'estimatorReplaced': [cgmesProfile.OP.value, ],
						'failure': [cgmesProfile.OP.value, ],
						'oldData': [cgmesProfile.OP.value, ],
						'operatorBlocked': [cgmesProfile.OP.value, ],
						'oscillatory': [cgmesProfile.OP.value, ],
						'outOfRange': [cgmesProfile.OP.value, ],
						'overFlow': [cgmesProfile.OP.value, ],
						'source': [cgmesProfile.OP.value, ],
						'suspect': [cgmesProfile.OP.value, ],
						'test': [cgmesProfile.OP.value, ],
						'validity': [cgmesProfile.OP.value, ],
						 }
