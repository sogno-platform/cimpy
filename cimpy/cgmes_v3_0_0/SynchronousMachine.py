...
class SynchronousMachine(RotatingMachine):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, cgmesProfile.SSH.value, cgmesProfile.EQ.value, cgmesProfile.SC.value, ],
						...
						'earthing': [cgmesProfile.SC.value, ],
						'earthingStarPointR': [cgmesProfile.SC.value, ],
						'earthingStarPointX': [cgmesProfile.SC.value, ],
						'ikk': [cgmesProfile.SC.value, ],
						'mu': [cgmesProfile.SC.value, ],
						'x0': [cgmesProfile.SC.value, ],
						'r0': [cgmesProfile.SC.value, ],
						'x2': [cgmesProfile.SC.value, ],
						'r2': [cgmesProfile.SC.value, ],
						'r': [cgmesProfile.SC.value, ],
						'satDirectSubtransX': [cgmesProfile.SC.value, ],
						'satDirectSyncX': [cgmesProfile.SC.value, ],
						'satDirectTransX': [cgmesProfile.SC.value, ],
						'shortCircuitRotorType': [cgmesProfile.SC.value, ],
						'voltageRegulationRange': [cgmesProfile.SC.value, ],
						 }
