...
class SubGeographicalRegion(IdentifiedObject):
	...
	:DCLines: The DC lines in this sub-geographical region. Default: "list"
	:Region: The geographical region which this sub-geographical region is within. Default: None
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						...
						'Lines': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'Substations': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						 }
