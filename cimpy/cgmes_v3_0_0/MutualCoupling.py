...
class MutualCoupling(IdentifiedObject):
	...
	possibleProfileList = {'class': [cgmesProfile.SC.value, ],
						'b0ch': [cgmesProfile.SC.value, ],
						'distance11': [cgmesProfile.SC.value, ],
						'distance12': [cgmesProfile.SC.value, ],
						'distance21': [cgmesProfile.SC.value, ],
						'distance22': [cgmesProfile.SC.value, ],
						'g0ch': [cgmesProfile.SC.value, ],
						'r0': [cgmesProfile.SC.value, ],
						'x0': [cgmesProfile.SC.value, ],
						'Second_Terminal': [cgmesProfile.SC.value, ],
						'First_Terminal': [cgmesProfile.SC.value, ],
						 }
	...
	def __init__(self, b0ch = 0.0, distance11 = 0.0, distance12 = 0.0, distance21 = 0.0, distance22 = 0.0, g0ch = 0.0, r0 = 0.0, x0 = 0.0, Second_Terminal = None, First_Terminal = None,  *args, **kw_args):
