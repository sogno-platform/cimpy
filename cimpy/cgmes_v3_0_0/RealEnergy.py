...
class RealEnergy(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.SSH.value, cgmesProfile.EQ.value, ],
						'multiplier': [cgmesProfile.SSH.value, cgmesProfile.EQ.value, ],
						'unit': [cgmesProfile.SSH.value, cgmesProfile.EQ.value, ],
						'value': [cgmesProfile.SSH.value, cgmesProfile.EQ.value, ],
						 }
