...
class GeneratingUnit(Equipment):
	...
	possibleProfileList = {'class': [cgmesProfile.SSH.value, cgmesProfile.EQ.value, ],
						...
						'startupTime': [cgmesProfile.EQ.value, ],
	...
	def __init__(self, normalPF = 0.0, ControlAreaGeneratingUnit = "list", genControlSource = None, governorSCD = 0.0, longPF = 0.0, maximumAllowableSpinningReserve = 0.0, maxOperatingP = 0.0, minOperatingP = 0.0, nominalP = 0.0, ratedGrossMaxP = 0.0, ratedGrossMinP = 0.0, ratedNetMaxP = 0.0, shortPF = 0.0, startupCost = 0.0, variableCost = 0.0, startupTime = 0, totalEfficiency = 0.0, GrossToNetActivePowerCurves = "list", RotatingMachine = "list",  *args, **kw_args):
