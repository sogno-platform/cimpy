...
class EquivalentBranch(EquivalentEquipment):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.SC.value, ],
						...
						'negativeR12': [cgmesProfile.SC.value, ],
						'negativeR21': [cgmesProfile.SC.value, ],
						'negativeX12': [cgmesProfile.SC.value, ],
						'negativeX21': [cgmesProfile.SC.value, ],
						'positiveR12': [cgmesProfile.SC.value, ],
						'positiveR21': [cgmesProfile.SC.value, ],
						'positiveX12': [cgmesProfile.SC.value, ],
						'positiveX21': [cgmesProfile.SC.value, ],
						'zeroR12': [cgmesProfile.SC.value, ],
						'zeroR21': [cgmesProfile.SC.value, ],
						'zeroX12': [cgmesProfile.SC.value, ],
						'zeroX21': [cgmesProfile.SC.value, ],
						 }
