...
class TapChanger(PowerSystemResource):
	...
	def __init__(self, controlEnabled = False, step = 0.0, TapSchedules = "list", highStep = 0, lowStep = 0, ltcFlag = False, neutralStep = 0, neutralU = 0.0, normalStep = 0, TapChangerControl = None, SvTapStep = None,  *args, **kw_args):
