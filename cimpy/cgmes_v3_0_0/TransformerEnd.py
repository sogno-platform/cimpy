...
class TransformerEnd(IdentifiedObject):
	...
	:PhaseTapChanger: Phase tap changer associated with this transformer end. Default: None
	:RatioTapChanger: Ratio tap changer associated with this transformer end. Default: None
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.SC.value, ],
						...
						'rground': [cgmesProfile.SC.value, ],
						'grounded': [cgmesProfile.SC.value, ],
						'xground': [cgmesProfile.SC.value, ],
						 }
	...
	def __init__(self, BaseVoltage = None, PhaseTapChanger = None, RatioTapChanger = None, Terminal = None, endNumber = 0, rground = 0.0, grounded = False, xground = 0.0,  *args, **kw_args):
