...
class WindTurbineType3or4IEC(WindTurbineType3or4Dynamics):
	...
	def __init__(self, WindContCurrLimIEC = None, WIndContQIEC = None, WindContQLimIEC = None, WindContQPQULimIEC = None, WindProtectionIEC = None, WindRefFrameRotIEC = None,  *args, **kw_args):
