...
class CrossCompoundTurbineGovernorDynamics(DynamicsFunctionBlock):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, ],
						'HighPressureSynchronousMachineDynamics': [cgmesProfile.DY.value, ],
						'LowPressureSynchronousMachineDynamics': [cgmesProfile.DY.value, ],
						 }
	...
	def __init__(self, HighPressureSynchronousMachineDynamics = None, LowPressureSynchronousMachineDynamics = None,  *args, **kw_args):
		super().__init__(*args, **kw_args)
	
		self.HighPressureSynchronousMachineDynamics = HighPressureSynchronousMachineDynamics
		self.LowPressureSynchronousMachineDynamics = LowPressureSynchronousMachineDynamics
