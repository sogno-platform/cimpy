...
class ExcDC1A(ExcitationSystemDynamics):
	...
	def __init__(self, ka = 0.0, ks = 0.0, ta = 0, tb = 0, tc = 0, vrmax = 0.0, vrmin = 0.0, ke = 0.0, te = 0, kf = 0.0, tf = 0, efd1 = 0.0, seefd1 = 0.0, efd2 = 0.0, seefd2 = 0.0, exclim = False, efdmin = 0.0, efdmax = 0.0,  *args, **kw_args):
