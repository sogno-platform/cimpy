...
class AnalogControl(Control):
	...
	:AnalogValue: The MeasurementValue that is controlled. Default: None
		'''

	cgmesProfile = Control.cgmesProfile

	possibleProfileList = {'class': [cgmesProfile.OP.value, ],
						'maxValue': [cgmesProfile.OP.value, ],
						'minValue': [cgmesProfile.OP.value, ],
						'AnalogValue': [cgmesProfile.OP.value, ],
						 }
