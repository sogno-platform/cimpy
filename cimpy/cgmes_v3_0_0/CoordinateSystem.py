...
class CoordinateSystem(IdentifiedObject):
	...
	:Locations: All locations described with position points in this coordinate system. Default: "list"
		'''
	...
	possibleProfileList = {'class': [cgmesProfile.GL.value, ],
						...
						'Locations': [cgmesProfile.GL.value, ],
						 }
	...
	def __init__(self, crsUrn = '', Locations = "list",  *args, **kw_args):
