...
class PssRQB(PowerSystemStabilizerDynamics):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, ],
						...
						'ki3': [cgmesProfile.DY.value, ],
						'ki4': [cgmesProfile.DY.value, ],
						't4m': [cgmesProfile.DY.value, ],
						'tomd': [cgmesProfile.DY.value, ],
						'tomsl': [cgmesProfile.DY.value, ],
						't4mom': [cgmesProfile.DY.value, ],
						'sibv': [cgmesProfile.DY.value, ],
						'kdpm': [cgmesProfile.DY.value, ],
						't4f': [cgmesProfile.DY.value, ],
						 }
	...
	def __init__(self, ki2 = 0.0, ki3 = 0.0, ki4 = 0.0, t4m = 0, tomd = 0, tomsl = 0, t4mom = 0, sibv = 0.0, kdpm = 0.0, t4f = 0,  *args, **kw_args):
