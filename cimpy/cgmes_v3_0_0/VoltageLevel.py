...
class VoltageLevel(EquipmentContainer):
	...
	possibleProfileList = {'class': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'BaseVoltage': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'Bays': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'Substation': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'highVoltageLimit': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						'lowVoltageLimit': [cgmesProfile.EQ.value, cgmesProfile.EQBD.value, ],
						 }
