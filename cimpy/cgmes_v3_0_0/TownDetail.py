...
class TownDetail(Base):
	...
	possibleProfileList = {'class': [cgmesProfile.GL.value, ],
						...
						'section': [cgmesProfile.GL.value, ],
						'name': [cgmesProfile.GL.value, ],
						'stateOrProvince': [cgmesProfile.GL.value, ],
						'country': [cgmesProfile.GL.value, ],
						 }
	...
	def __init__(self, code = '', section = '', name = '', stateOrProvince = '', country = '',  ):
