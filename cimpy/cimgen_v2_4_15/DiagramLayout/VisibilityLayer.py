...
class VisibilityLayer(IdentifiedObject):
	...
	:drawingOrder: The drawing order for this layer.  The higher the number, the later the layer and the objects within it are rendered. Default: 0.0
		'''
	...
	def __init__(self, VisibleObjects = [], drawingOrder = 0.0,  *args, **kw_args):
