...
class WindDynamicsLookupTable(IdentifiedObject):
	...
	:sequence: Sequence numbers of the pairs of the input (x) and the output (y) of the lookup table function. Default: 0.0
	...
	def __init__(self, WindContCurrLimIEC = None, WindContPType3IEC = None, WindContRotorRIEC = None, input = 0.0, lookupTableFunctionType = None, output = 0.0, sequence = 0.0, WindPlantFreqPcontrolIEC = None,  *args, **kw_args):
