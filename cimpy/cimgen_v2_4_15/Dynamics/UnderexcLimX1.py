from cimpy.cimgen_v2_4_15.Dynamics.UnderexcitationLimiterDynamics import UnderexcitationLimiterDynamics
...
class UnderexcLimX1(UnderexcitationLimiterDynamics):
	...
	def __init__(self, kf2 = 0.0, tf2 = 0.0, km = 0.0, tm = 0.0, melmax = 0.0, k = 0.0,  *args, **kw_args):
