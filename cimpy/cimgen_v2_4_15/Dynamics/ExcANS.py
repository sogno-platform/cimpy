from cimpy.cimgen_v2_4_15.Dynamics.ExcitationSystemDynamics import ExcitationSystemDynamics
...
class ExcANS(ExcitationSystemDynamics):
	...
	:blint: Governor Control Flag (BLINT).  0 = lead-lag regulator 1 = proportional integral regulator. Typical Value = 0. Default: 0.0
	:kvfif: Rate feedback signal flag (K).  0 = output voltage of the exciter 1 = exciter field current. Typical Value = 0. Default: 0.0
	...
	:krvecc: Feedback enabling (K).  0 = Open loop control 1 = Closed loop control. Typical Value = 1. Default: 0.0
	...
	def __init__(self, k3 = 0.0, k2 = 0.0, kce = 0.0, t3 = 0.0, t2 = 0.0, t1 = 0.0, blint = 0.0, kvfif = 0.0, ifmn = 0.0, ifmx = 0.0, vrmn = 0.0, vrmx = 0.0, krvecc = 0.0, tb = 0.0,  *args, **kw_args):
