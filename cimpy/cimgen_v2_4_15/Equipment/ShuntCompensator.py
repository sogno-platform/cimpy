from cimpy.cimgen_v2_4_15.Equipment.RegulatingCondEq import RegulatingCondEq
...
class ShuntCompensator(RegulatingCondEq):
	...
	:maximumSections: The maximum number of sections that may be switched in. Default: 0.0
	...
	:normalSections: The normal number of sections switched in. Default: 0.0
	:switchOnCount: The switch on count since the capacitor count was last reset or initialized. Default: 0.0
	...
	reference_dict = { 'StateVariablesVersion': ['SvShuntCompensatorSections', ],
					'SteadyStateHypothesisVersion': ['sections', ],
					 } 

	__doc__ += '\n Documentation of parent class RegulatingCondEq: \n' + RegulatingCondEq.__doc__ 

	def __init__(self, aVRDelay = 0.0, grounded = False, maximumSections = 0.0, nomU = 0.0, normalSections = 0.0, switchOnCount = 0.0, switchOnDate = '', voltageSensitivity = 0.0, SvShuntCompensatorSections = None, sections = 0.0,  *args, **kw_args):
