...
class BusNameMarker(IdentifiedObject):
	...
	:priority: Priority of bus name marker for use as topology bus name.  Use 0 for don t care.  Use 1 for highest priority.  Use 2 as priority is less than 1 and so on. Default: 0.0
	...
	def __init__(self, priority = 0.0, ReportingGroup = None, Terminal = [],  *args, **kw_args):
