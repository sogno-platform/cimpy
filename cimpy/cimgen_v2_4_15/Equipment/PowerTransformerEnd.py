from cimpy.cimgen_v2_4_15.Equipment.TransformerEnd import TransformerEnd
...
class PowerTransformerEnd(TransformerEnd):
	...
	def __init__(self, PowerTransformer = None, b = 0.0, connectionKind = None, ratedS = 0.0, g = 0.0, ratedU = 0.0, r = 0.0, x = 0.0, b0 = 0.0, phaseAngleClock = 0.0, g0 = 0.0, r0 = 0.0, x0 = 0.0,  *args, **kw_args):
