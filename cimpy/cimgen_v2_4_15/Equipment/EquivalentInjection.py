from cimpy.cimgen_v2_4_15.Equipment.EquivalentEquipment import EquivalentEquipment
...
class EquivalentInjection(EquivalentEquipment):
	...
	reference_dict = { 'SteadyStateHypothesisVersion': ['regulationStatus','regulationTarget','p','q', ],
					 } 
