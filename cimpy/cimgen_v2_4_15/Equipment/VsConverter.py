from cimpy.cimgen_v2_4_15.Equipment.ACDCConverter import ACDCConverter
...
class VsConverter(ACDCConverter):
	...
	reference_dict = { 'StateVariablesVersion': ['delta','uf', ],
					'SteadyStateHypothesisVersion': ['droop','droopCompensation','pPccControl','qPccControl','qShare','targetQpcc','targetUpcc', ],
					 } 
