...
class PositionPoint(Base):
	...
	:sequenceNumber: Zero-relative sequence number of this point within a series of points. Default: 0.0
	...
	def __init__(self, Location = None, sequenceNumber = 0.0, xPosition = '', yPosition = '', zPosition = '',  ):
