...
class WindDynamicsLookupTable(IdentifiedObject):
    ...
    def __init__(
        ...
        WindContPType3IEC=None,
        WindContQPQULimIEC=None,
        WindContRotorRIEC=None,
        input=0.0,
        lookupTableFunctionType=None,
        output=0.0,
        sequence=0,
        WindPlantFreqPcontrolIEC=None,
        WindProtectionIEC=None,
        WindPlantReactiveControlIEC=None,
        WindGenType3bIEC=None,
        WindPitchContPowerIEC=None,
        *args,
        **kw_args,
    ):
