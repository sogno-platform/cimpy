...
class PhaseTapChangerTablePoint(TapChangerTablePoint):
    ...
    :angle: The angle difference in degrees. A positive value indicates a positive angle variation from the Terminal at the  PowerTransformerEnd,  where the TapChanger is located, into the transformer. Default: 0.0
    """
