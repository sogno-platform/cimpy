...
class RegularIntervalSchedule(BasicIntervalSchedule):
    ...
    :endTime: The time for the last time point.  The value can be a time of day, not a specific date. Default: ''
    """
    ...
    def __init__(self, TimePoints="list", timeStep=0, endTime="", *args, **kw_args):
