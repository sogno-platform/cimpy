...
class SynchronousMachineDynamics(RotatingMachineDynamics):
    ...
    def __init__(
        ...
        CrossCompoundTurbineGovernorDyanmics=None,
        CrossCompoundTurbineGovernorDynamics=None,
        MechanicalLoadDynamics=None,
        ExcitationSystemDynamics=None,
        TurbineGovernorDynamics="list",
        GenICompensationForGenJ="list",
        *args,
        **kw_args,
    ):
