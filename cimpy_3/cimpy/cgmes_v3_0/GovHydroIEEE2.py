...
class GovHydroIEEE2(TurbineGovernorDynamics):
    ...
    :uc: Maximum gate closing velocity (<i>Uc</i>) (&lt;0).  Typical value = -0,1. Default: 0.0
    :pmax: Maximum gate opening (<i>Pmax</i>) (&gt; GovHydroIEEE2.pmin).  Typical value = 1. Default: 0.0
    :pmin: Minimum gate opening (<i>Pmin</i>) (&lt;GovHydroIEEE2.pmax).  Typical value = 0. Default: 0.0
