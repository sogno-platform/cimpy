...
class WindPlantDynamics(DynamicsFunctionBlock):
    ...
    :RemoteInputSignal: The remote signal with which this power plant is associated. Default: None
    :WindTurbineType3or4Dynamics: The wind turbine type 3 or type 4 associated with this wind plant. Default: "list"
    """
    ...
    def __init__(
        self,
        RemoteInputSignal=None,
        WindTurbineType3or4Dynamics="list",
        *args,
        **kw_args,
    ):
