...
class UnderexcLimX2(UnderexcitationLimiterDynamics):
    ...
    :qo: Excitation centre setting (<i>Q</i><i><sub>O</sub></i>). Default: 0.0
    :r: Excitation radius (<i>R</i>). Default: 0.0
    """
    ...
    def __init__(
        self, kf2=0.0, tf2=0, km=0.0, tm=0, melmax=0.0, qo=0.0, r=0.0, *args, **kw_args
    ):
