...
class PowerTransformer(ConductingEquipment):
    ...
    def __init__(
        self,
        PowerTransformerEnd="list",
        beforeShCircuitHighestOperatingCurrent=0.0,
        beforeShCircuitHighestOperatingVoltage=0.0,
        beforeShortCircuitAnglePf=0.0,
        highSideMinOperatingU=0.0,
        isPartOfGeneratorUnit=False,
        operationalValuesConsidered=False,
        *args,
        **kw_args,
    ):
        ...
        self.beforeShCircuitHighestOperatingCurrent = (
            beforeShCircuitHighestOperatingCurrent
        )
        self.beforeShCircuitHighestOperatingVoltage = (
            beforeShCircuitHighestOperatingVoltage
        )
