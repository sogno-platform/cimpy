...
class BasicIntervalSchedule(IdentifiedObject):
    ...
    :startTime: The time for the first time point.  The value can be a time of day, not a specific date. Default: ''
    ...
    def __init__(
        self, startTime="", value1Unit=None, value2Unit=None, *args, **kw_args
    ):
