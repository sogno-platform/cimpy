...
class DCConverterUnit(DCEquipmentContainer):
    ...
    :operationMode: The operating mode of an HVDC bipole (bipolar, monopolar metallic return, etc). Default: None
    :Substation: The containing substation of the DC converter unit. Default: None
    """
