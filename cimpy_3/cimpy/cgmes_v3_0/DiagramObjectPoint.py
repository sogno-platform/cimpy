...
class DiagramObjectPoint(Base):
    ...
    :DiagramObjectGluePoint: The `glue` point to which this point is associated. Default: None
    :sequenceNumber: The sequence position of the point, used for defining the order of points for diagram objects acting as a polyline or polygon with more than one point. The attribute shall be a positive value. Default: 0
